...
# PLOT DATA
plot 'data_mem.dat' using 2:6 fs pattern 1 ti col fc rgb color_one,   \
     'data_mem.dat' using 3:7 fs pattern 2 ti col fc rgb color_two,   \
     'data_mem.dat' using 4:8 fs pattern 5 ti col fc rgb color_three, \
     'data_mem.dat' using 5:9 fs pattern 4 ti col fc rgb color_four
