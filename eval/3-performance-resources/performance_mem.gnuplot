...
set output "../charts/3-performance_mem.eps"
...
set ylabel "Average Memory Usage (%)"
...
# PLOT DATA
plot 'data_mem.dat' using 2:6 fs pattern 4 ti col lc rgb darkmagenta, \
     'data_mem.dat' using 3:7 fs pattern 2 ti col, \
     'data_mem.dat' using 4:8 fs pattern 1 ti col, \
     'data_mem.dat' using 5:9 fs pattern 3 ti col lc rgb darkcyan
